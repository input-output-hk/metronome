...
object CheckpointingConsensusTracers {

  type CheckpointingConsensusEvent = ConsensusEvent[CheckpointingAgreement]

  implicit val consensusEventHybridLog
      : HybridLog[Task, ConsensusEvent[CheckpointingAgreement]] = {
    ...
    HybridLog.instance[Task, CheckpointingConsensusEvent](
      level = {
  ...
  implicit val consensusEventHybridLogTracer =
    LogTracer.hybrid[Task, CheckpointingConsensusEvent]
